  ...
  return (
    <tr className="bg-white border-b">
      ...
      <td className="px-6 py-4 text-right">
        <button className="font-medium text-yellow-600 hover:underline">Edit</button>
...
function CreateUserModal({open, setOpen, setUsers}: {open:boolean, setOpen: Dispatch<SetStateAction<boolean>>, setUsers: Dispatch<SetStateAction<User[]>>}) {
  ...
  useEffect(() => {
    if (state.newUser !== undefined) setUsers(users => [state.newUser,...users]);
  }, [setUsers, state.newUser])
  return (
